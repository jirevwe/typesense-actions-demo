...
func (t *Typesense) Search(collection string, f *utils.SearchFilter) ([]string, utils.PaginationData, error) {
	docs := make([]string, 0)
...
func (t *Typesense) Remove(collection string, f *utils.SearchFilter) error {
	batchsize := 100
